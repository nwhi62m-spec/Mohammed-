...
TOKEN = '8389923559:AAE4VJDvtSkDXh3Ytm9YPNGDLGYaFNKdh4U' #توكنك 
ADMIN_ID = 8144153053  # ايديك
channel = '@GAGAGAFGK' #يوزر قناتك هنا مش الرابط
    ...
    try:
        ...
        if file_name.endswith('.zip'):
            ...
            if not file_name.endswith('.py'):
                bot.reply_to(message, "⚠️ هذا البوت خاص برفع ملفات بايثون أو php فقط. 🐍")
                return
